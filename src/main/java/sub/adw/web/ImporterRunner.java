...
import sub.adw.FileAccess;
import sub.adw.Importer;
import sub.adw.Timer;
...
//			Thread.sleep(11000);
//			checkIfContinue();
			importer.convert(inputExcel(), solrXmlDir());
			checkIfContinue();
			importer.upload(solrXmlDir(), solrUrl(), solrImportCore());
			checkIfContinue();
